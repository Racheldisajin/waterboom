    ...
    return (
        <div className="superadmin-dashboard-container">
            ...
            <main className="superadmin-main">
                ...
                <header className="superadmin-header">
                    <div className="header-title-column">
                        <h1>
                            ...
                            {activeTab === 'rekap_keuangan' && 'Laporan Keuangan'}
                        ...
                        <p>
                            ...
                            {activeTab === 'rekap_keuangan' && 'Tinjauan ringkas laba rugi bulanan'}
                    ...
                    <div className="header-controls-column">
                        ...
                        <div className="user-profile-dropdown-container" onClick={() => setShowProfileDropdown(!showProfileDropdown)}>
                            <div className="avatar-capsule">
                                <img src="assets/logo.png" alt="Avatar" className="user-avatar-img" />
                ...
                {/* TAB: LAPORAN (PRINT LAYOUTS) */}
                {(activeTab === 'rekap_keuangan' || activeTab === 'laporan_penjualan' || activeTab === 'laporan_layanan') && (
                    <div className="data-table-card print-report-container">
                        <div className="table-header-block" style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <h3>
                                {activeTab === 'rekap_keuangan' && 'Laporan Ringkasan Rekap Keuangan'}
                        ...
                        <div className="report-metadata-box" style={{ backgroundColor: '#f8fafc', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0', margin: '20px 0', fontSize: '0.88rem' }}>
                            <div><strong>Unit Bisnis:</strong> {systemSettings.businessName}</div>
                            <div><strong>Periode Laporan:</strong> {dateRange}</div>
                            ...
                            <table className="superadmin-table">
                                ...
                                <tbody>
                                    {activeTab === 'rekap_keuangan' && (
                                        <>
                                            <tr><td>Pemasukan Operasional Tiket & Layanan</td><td>{rentals.totalQty + 1024} unit</td><td className="font-bold text-green">Rp {kpis.inflow.toLocaleString('id-ID')}</td></tr>
                                            <tr><td>Pengeluaran Operasional Harian</td><td>{expenditures.length} log</td><td className="font-bold text-red">Rp {kpis.outflow.toLocaleString('id-ID')}</td></tr>
                                            <tr className="total-row-highlight"><td><strong>Laba Bersih Operasional</strong></td><td>-</td><td className="font-bold text-blue"><strong>Rp {(kpis.inflow - kpis.outflow).toLocaleString('id-ID')}</strong></td></tr>
                                        </>
                                    )}
